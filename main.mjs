...
export function loop() {
    ...
    {
        if(getRange(enemyCreeps[enemyIndex], myFlag) < getRange(rangedCreeps[0], myFlag) + 25)
        {
            defensive = true;
    ...
    {
        if(getRange(enemyCreeps[enemyIndex], myFlag) < getRange(attackCreeps[0], myFlag) + 25)
        {
            defensive = true;
